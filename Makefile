# CricketIQ — Production Pipeline Makefile
# ==========================================
# Usage:
...
## Ingest raw Ball Tracking data to Bronze layer
ingest:
	@echo "🟤 Ingesting Ball Tracking: $(DATE_START) → $(DATE_END)"
...
## Train bowler effectiveness model
train:
	@echo "📈 Training XGBoost bowler effectiveness model"
...
report:
	@echo "📋 Generating scouting report: bowler=$(PLAYER_ID), date=$(DATE)"
...
setup:
	...
	@echo "✅ Environment ready. Add your GROQ_API_KEY to .env"
...
demo:
	...
	DEMO_MODE=1 $(PYTHON) reports.scouting_report \
		--bowler-id 605483 --game-date 2024-07-01

help:
	@echo ""
	@echo "CricketIQ — Sports Analytics Pipeline"
	@echo "======================================="

...
models/train.py
===============
Train an XGBoost model to predict bowler Dot Ball Percentage (called strikes + whiffs / deliveries).

Dot Ball Percentage is the single best predictor of bowler value in a given game start —
preferred by modern front offices over ERA, WHIP, or even wicket rate.
...
FEATURE_COLS = [
    ...
    "boundary_rate_allowed",
    "avg_expected_runs_per_ball_allowed",

    # Contextual
    "total_pitches",        # delivery count = proxy for workload
